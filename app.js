...
from
follower
left join tweet on tweet.user_id = follower.following_user_id left join user on follower.following_user_id = user.user_id
...
like natural join user where tweet_id = ${tweetId};`)
...
app.post('/user/tweets/', authenticateToken, async (request, response) => {
  ...
  await db.run(`Insert into tweet (tweet, user_id) values
("${tweet}",${user_id});`)
